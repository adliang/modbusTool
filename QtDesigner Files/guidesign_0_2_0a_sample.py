...
# Form implementation generated from reading ui file 'guidesign_0_2_0a_sample.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        item = QtWidgets.QTableWidgetItem()
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../modbus.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        item.setIcon(icon1)
